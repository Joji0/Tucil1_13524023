...
Berikut adalah source code program penyelesaian permainan Queens LinkedIn yang ditulis dalam bahasa C++ dengan GUI menggunakan SFML 3.0. Kode terdapat dalam satu file \texttt{src/main.cpp}.

\begin{lstlisting}[language=C++, caption={main.cpp --- Aplikasi Penyelesaian Queens LinkedIn (C++/SFML)}]
